...
async function main() {
    ...
    user3 = await user.createUser("img2", "Ross", "Geller", "user03", "rg123@gmail.com", "friends1234", "336-237-4673", "United States", "Hello I am Ross. I am from US", "Male", "Patient", "1990-02-28")
    ...
    user5 = await user.createUser("jpg2", "Lee", "min ho", "user05", "lee03@gmail.com", "flowers74", "436-256-4653", "South Korea", "Hello I am Lee. I am from SK", "Male", "Patient", "1982-04-13")
